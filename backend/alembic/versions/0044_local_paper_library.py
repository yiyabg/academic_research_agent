...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "requested_by", uuid, sa.ForeignKey("users.id", ondelete="RESTRICT"), nullable=False
        ),
    ...
    op.create_index(
        "ix_local_paper_quarantine_items_library_id", "local_paper_quarantine_items", ["library_id"]
    )
    op.create_index(
        "ix_local_paper_quarantine_items_sync_run_id",
        "local_paper_quarantine_items",
        ["sync_run_id"],
    )
    op.create_index(
        "ix_local_paper_quarantine_items_item_kind", "local_paper_quarantine_items", ["item_kind"]
    )
