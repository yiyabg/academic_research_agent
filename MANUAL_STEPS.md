# Manual setup steps for academic_research_agent
...
- [ ] (Optional) Ingest seed documents: `uv run academic_research_agent rag-ingest /path/to/file.pdf --collection docs`.
